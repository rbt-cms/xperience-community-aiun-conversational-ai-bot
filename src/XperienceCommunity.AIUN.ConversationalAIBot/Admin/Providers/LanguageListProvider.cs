...
{
    public class LanguageListProvider : IGeneralSelectorDataProvider
    {
        private readonly IInfoProvider<ContentLanguageInfo> contentLanguageInfoProvider;
        public LanguageListProvider(IInfoProvider<ContentLanguageInfo> contentLanguageInfoProvider) => this.contentLanguageInfoProvider = contentLanguageInfoProvider;
